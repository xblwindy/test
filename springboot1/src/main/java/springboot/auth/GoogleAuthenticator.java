 ...
 * @ProjectName user
 * @Description: google身份验证器，java服务端实现
 * @date 2018/11/2014:01
 */
@Component
public class GoogleAuthenticator {
    ...
    public static void main(String[] args) {
        ...
        String qrcode = GoogleAuthenticator.getQRBarcode("2665747917@qq.com", secret);
...
//        System.out.println(secret);
    ...
    private static void test2() {
        ...
        ga.setWindowSize(5);
        boolean r = ga.check_code("KAM67TXQIEMBCV6Y", code, t);
